...
private:
    ...
    std::tuple<double, VD, CONVERGENCETYPE> integrateProfile(VD y0, VD y_desire, double dr0, double phi_eps_rel_,
...
public:
    Kink1D(double phi_left_, double phi_right_, V1D V_, V1D dV_, V1D d2V_, double phi_eps_rel_ = 1e-6,
           bool scaled_ = false);
    ~Kink1D(){};
