...
public:
    ...
    bool Set_Physical_Parameters(double beta, double m2, double m3, double mpm, double alpha, double alphac);
    ...
    void GetTheta(double &theta) {theta = _theta;};
    std::string repr();
    friend std::ostream &operator<<(std::ostream &os, const THDM_SCPV1 &mod);
};
